...
cartella_audio = '/Volumes/WD_1T_VALE/rec/2015/' % Controlla che il nome sia giusto!
...
for k = 1:length(lista_file)
    ...
    try
        ...
        writetable(Tabella_Risultati, 'Analisi_fischi_2015_86%2.xlsx', 'WriteMode', 'append');
